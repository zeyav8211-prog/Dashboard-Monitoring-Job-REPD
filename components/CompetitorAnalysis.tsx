        ...
        setTimeout(() => {
            const mockData: CompetitorRow[] = [
                ...
                },
                {
                 ...
                 {
                    id: '5', kodingOrigin: 'CGK10000', origin: 'JAKARTA', destinasi: 'MES10000', provinsi: 'Sumatera Utara', kabKota: 'Medan', kecamatan: 'MEDAN KOTA', regional: 'Sumatera',
                    jneRegPrice: 37000, jneRegSla: '2-3', jntRegPrice: 38000, jntRegSla: '2-3', lionRegPrice: 35000, lionRegSla: '2-4', sicepatRegPrice: 37000, sicepatRegSla: '2-3',
                    jneTruckPrice: 120000, jneTruckSla: '5-7', jntTruckPrice: 125000, jntTruckSla: '5-7', lionTruckPrice: 110000, lionTruckSla: '6-8', wahanaTruckPrice: 0, wahanaTruckSla: '-'
                }
            ];
            setRows(mockData);
            setIsLoading(false);
