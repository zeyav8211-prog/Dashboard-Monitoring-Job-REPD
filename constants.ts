...
export const EMAILJS_TEMPLATE_ID = "template_gsea84b"; // WAJIB DIISI: Template ID dari EmailJS, cth: "template_abc123"
export const EMAILJS_PUBLIC_KEY = "CLG_VvYhA6G8HIXrT";  // WAJIB DIISI: Public Key dari EmailJS, cth: "user_xyz123"
